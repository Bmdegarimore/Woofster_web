<div class="text-center container">
    ...
    <form  class="form-horizontal" method="post" action="?select=events">
        ...
        <div class="col-sm-6">
            ...
            <input type="text" class="form-control" name="eventTitle" id="eventTitle" value="<?php if(isset($_GET['row'])){echo($events[$_GET['row']][title]);}; ?>">
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-12">
            ...
            <textarea class="form-control" rows="4" name="notes" id="notes"><?php if(isset($_GET['id'])){echo($events[$_GET['row']][notes]);}; ?></textarea>
        </div>
